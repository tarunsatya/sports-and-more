...
$forgotPasswordFromDb = mysqli_query($dbCon,"select * from tbl_users where user_email='".$mob."'");

if(mysqli_num_rows($forgotPasswordFromDb) >= 1)
{
  $to = $mob;
  $otp = rand(10,1000000);
...
.main{background-color:#000}.logo a:hover,.logo a:focus{color:#fff !important}.mso .layout-has-border{border-top:1px solid #000;border-bottom:1px solid #000}.mso .layout-has-bottom-border{border-bottom:1px solid #000}.mso .border,.ie .border{background-color:#000}.mso h1,.ie h1{}.mso h1,.ie h1{font-size:36px !important;line-height:43px !important}.mso h2,.ie h2{}.mso h2,.ie h2{font-size:22px !important;line-height:31px !important}.mso h3,.ie h3{}.mso h3,.ie h3{font-size:18px !important;line-height:26px !important}.mso .layout__inner,.ie .layout__inner{}.mso .footer__share-button p{}.mso .footer__share-button p{font-family:Ubuntu,sans-serif}
...
<!--<![endif]-->
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #000;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    <div role="banner">
      ...
      <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
          <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 194px;" src="images/sig_new_logo.png" alt="" width="194" /></div>
        </div>
      <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
      </div>
    </div>
    ...
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
     <center> <img src="https://www.sportsandmore.it/assets/images/logo1.png" style="width:100px;"></center><br/>
<h1 style="text-align:center;">Here is your 6 Digits OTP!</h1>
    </div>
  </div>
    ...
    <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
      <![if !mso]><p style="border-radius: 4px;display: inline-block;font-size: 24px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #80bf2e;font-family: Ubuntu, sans-serif;">.$otp.</p><![endif]>
    <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://test.com" style="width:219px" arcsize="9%" fillcolor="#80BF2E" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">COMPLETE THE SURVEY</center></v:textbox></v:roundrect><![endif]--></div>
  </div>
    ...
    <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
          ...
          <div style="Margin-left: 20px;Margin-right: 20px;">
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
     <center> <p style="Margin-top: 0;Margin-bottom: 20px;"><em>Please Use Above 6 Digits code to Reset your Password</em></p></center>
    </div>
  </div>
...
// More headers
$headers .= 'From: <info@makersmind.in>' . "\r\n";
$headers .= 'Cc: info@makersmind.in' . "\r\n";

$email = mail($to,$subject,$message,$headers); 

if ($email) {
  $stat = ['success' => 'OTP sent to your Email','OTP'=>$otp];
} else {
  $stat = ['fail' => 'Failed to send OTP'];
}
}
else
{
