...
if(isset($headers['Authorization']))
{
    ...
    $courtPrices = mysqli_real_escape_string($dbCon,$jsondecode_data->courtPrices);
        $query = mysqli_query($dbCon, "insert into court_booking set user_id='".$decoded->user_id."', ground_id='".$ground_id."', game_id='".$game_id."',court_id='".$court_id."', select_date='".$select_date."', time_slot_start='".$time_slot_start."',time_slot_end='".$time_slot_end."',pickaside_count='".$pickaside_count."',courtToken='".$courtToken."',court_price='".$courtPrices."', game_status='1', status='1'");
