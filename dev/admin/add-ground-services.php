    ...
    <div class="col-xl-6 col-lg-8 justify-content-center">
        <div class="card main-car">
            <div class="card-header justify-content-center">
                <h4 class="card-title">Add Ground Services</h4>
            </div>
            <div class="card-body">
                <div class="basic-form">
                    <form method="post" enctype="multipart/form-data" id="">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9 form-align">
                                <input type="text" class="form-control" placeholder="Enter Ground Service name" name="ground_service_name"
                                    id="ground_service_name" />
                                <p id="prod_name_err" class="p-sty"></p>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="w-100">
                                <label class="col-sm-5 col-form-label">Add ground service icon</label>
                            </div>
                            <div class="col-sm-9 form-align1">

                                <input type="file" class="form-control" placeholder="Upload Image" name="ground_service_icon"
                                    id="ground_service_icon" />
                                <p id="img3_err" class="p-sty"></p>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-primary" name="add_ground_service" id="add_ground_service">
                                    Add Ground Services
                                </button>
                            </div>
                        </div>
