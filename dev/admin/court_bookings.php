                    ...
                    <div class="card-body">
                        <div class="table-responsive table-padd">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php
                                     $getcourtbook = mysqli_query($conn,"select * from court_booking a,tbl_game b, tbl_grounds c,tbl_users d, tbl_court e where a.game_id=b.id && a.ground_id=c.ground_id && a.court_id=e.court_id && a.status=2 && d.user_id=a.user_id order by a.booking_id DESC");
