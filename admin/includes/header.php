...
<head>
    ...
    <meta name="description" content="Berry box Admin dashboard" />
    <meta property="og:title" content="Berry box Admin dashboard" />
    <meta property="og:description" content="Berry box Admin dashboard" />
    <meta property="og:image" content="social-image.png" />
    <meta name="format-detection" content="telephone=no" />

    <!-- PAGE TITLE HERE -->
    <title>Winner App Admin dashboard</title>
    <!-- FAVICONS ICON -->
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Montserrat+Alternates:ital,wght@0,100;0,200;0,300;0,500;0,700;1,400&display=swap"
        rel="stylesheet">
</head>
        ...
        ***********************************-->
        <div class="nav-header text-center">
            <a href="index.php" class="brand-logo">
                ...
                <h5 class="text-center class-l-name">Winner App</h5>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <!-- <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link ai-icon" href="javascript:void(0);" role="button"
                                    ...
                                    <svg width="28" height="28" viewBox="0 0 28 28" fill=""
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="logout.php" class="dropdown-item ai-icon">
                                        ...
                                        <span class="ms-2 d-in"><a href="logout.php">Logout</a></span>
                                    </a>
                                </div>
                            </li>
                        </ul>
